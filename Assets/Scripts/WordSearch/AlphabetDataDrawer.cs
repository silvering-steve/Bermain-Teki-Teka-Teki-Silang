...
public class AlphabetDataDrawer: Editor
{
    ...
    {
        InitilalizeReoderdableList(ref AlphabetPlainList, "alphabetPlain", "Alphabet Plain");
        InitilalizeReoderdableList(ref AlphabetNormalList, "alphabetNormal", "Alphabet Normal");
        InitilalizeReoderdableList(ref AlphabetHighlightedList, "alphabetHighlighted", "Alphabet Highlighted");
        InitilalizeReoderdableList(ref AlphabetWrongList, "alphabetWrong", "Alphabet Wrong");
    }
    ...
    private void InitilalizeReoderdableList(ref ReorderableList list, string propertyName, string listLabel)
    {
        ...
        list.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
        {
            ...
            EditorGUI.PropertyField(new Rect(rect.x + 70, rect.y, rect.width - 60 - 30, 
