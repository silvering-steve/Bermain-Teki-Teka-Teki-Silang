...
public class TTSManager3 : MonoBehaviour
{
    [System.Serializable]
    public class SoalTTS
    {
        ...
        public List<TTSKotak3> listKotakJawab;
    }
    ...
    [Header("Jawab")] 
    public List<TTSKotak3> kotakAll;
    public List<TTSKotak3> kotakSebagian;
    public TTSKotak3 kotakSelected;
    ...
    private void Awake()
    {
        ...
        satuDtemp = new List<string> {"T", "S", "A", "B", "W", "H"};
        duaDtemp = new List<string> {"M", "A", "J", "U", "N", "D", "R"};
        tigaDtemp = new List<string> {"C", "O", "N", "G", "K", "E", "L"};
        empatDtemp = new List<string> {"B", "U", "L", "A", "T"};
        limaDtemp = new List<string> {"M", "A", "J", "U", "N", "D", "R"};
