...
public class TTSManager7 : MonoBehaviour
{
    [System.Serializable]
    public class SoalTTS
    {
        ...
        public List<TTSKotak7> listKotakJawab;
    }
    ...
    [Header("Jawab")] 
    public List<TTSKotak7> kotakAll;
    public List<TTSKotak7> kotakSebagian;
    public TTSKotak7 kotakSelected;
    ...
    private void Awake()
    {
        ...
        satuDtemp = new List<string> {"E", "A", "S", "N", "M", "B", "U", "L", "K", "I"};
